...
public class LinkedList<T> {
    ...
    public void merge(LinkedList<T> list2) {
        Node<T> c1 = this.head;
        Node<T> c2 = list2.head;
        while (c1 != null && c2 != null) {
            Node<T> t1 = c1.getNext(); //to have a hold of the next node in the first linked list so when we loop
            Node<T> t2 = c2.getNext(); //to have a hold of the next node in the second linked list so when we loop

            c1.setNext(c2); //sets the pointer of the current node to the current of second linked list
            if (t1 != null) { // can't point a null
                c2.setNext(t1); // if there is something there then the current node of the second linked list will point to the next node of the first linked list
            }
